...
public class Class_01 {
	...
	public static void main(String[] args) {
		...
		/*
		 * == 변수 선언문 ==
		 * 1. 정수형 변수 num1을 선언하고 정수 30을 할당해라.
		 * 2. 앞으로 num1이라는 변수를 사용하여 정수값을 저장하고,
		 * 		여러가지 기능을 수행할테니 변수를 준비해달라.
		 */
		int num1 = 0;
		num1 = 40;
