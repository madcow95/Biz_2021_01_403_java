...
public class Class_05 {
	...
	public static void main(String args[]) {
		...
		/*
		 * ()안의 값, 변수값, 연산식의 결과를 Console에 출력
		 * 출력한 후 자동 줄바꿈을 하여 이후 출력되는 결과가
		 * 		다음줄에 출력되도록 하는 기능
		 * ()안에 아무 것도 없으면 빈줄만 출력
		 */
		...
		System.out.printf("숫자 : %d \n" ,30000);
		System.out.println("===================================================");
		// 숫자를 %d 사이에 숫자만큼 오른쪽에서 부터 시작해라
		// 일단 15개 짜리 빈 공간을 만들고 숫자를 오른쪽 정렬
		...
		// 일단 15개 짜리 빈 공간읆 만들고 숫자를 왼쪽으로 정렬
		System.out.printf("숫자 : %-15d \n" ,3);
		System.out.printf("숫자 : %-15d \n" ,300);
		System.out.printf("숫자 : %-15d \n" ,3000);
		System.out.printf("숫자 : %-15d \n" ,30000);
		...
		// 실수표현
		// 정수부분 3자리, 소수점부분 2자리, 3번째에서 반올림 이라는 뜻
		// 		3				.2
