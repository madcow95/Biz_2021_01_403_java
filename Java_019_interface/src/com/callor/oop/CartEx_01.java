...
public class CartEx_01 {
	...
	/*
	 * Cart Project에서 CartServiceV1을 사용하여 cart 기능을 구현했다.
	 * 
	 * Cart Project를 사용하는 중에 CartService의 기능을 업그레이드 해야할 일이 발생했다.
	 * 		CartServiceV1을 그대로 두고, CartServiceV2를 새로 만들어
	...
	public static void main(String args[]) {
		 ...
		 // method를 호출하는 부분에서 상당히 많은 코드 변경이
		 // 수행되어야 한다.
