...
public class ProductVO {
	public int length = 5;
	public String[] strPCode = new String[length]; // 상품코드
	public String[] strPName = new String[length]; // 상품명(이름)
	public String[] strItem = new String[length];  // 품목
	public String[] strDName = new String[length]; // 거래처
	public int[] iPrice = new int[length];		// 매입단가
	public int[] oPrice = new int[length];		// 매출단가
	...
	public String toString(int num) {
		...
		//System.out.println("-------------------------------");
		System.out.println((num + 1) + "번 상품 데이터 확인");
		System.out.println("-------------------------------");
