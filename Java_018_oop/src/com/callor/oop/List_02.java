...
/*
 * List class
 * 배열의 단점을 보완하기 위해서 java의 JDK에 포함되어 있는
 * 데이터리스트를 관리하기 위한 class
 * 
 * 목적 1. 데이터(값)들을 다량으로 저장하는 용도의 객체 생성
 * 2. 배열을 선언하여 값을 저장하는 것과 비슷한 용도
 * 3. 처음 생성할때 몇 개의 데이터를 저장할지 결정하지 않고
...
public class List_02 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 배열은 처음 생성할 때 지정한 type 이외에는
		 * 다른 어떠한 type도 저장할 수 없다.
		 * 
		 * 이미 선언된 배열을 다른 type으로 다시 선언할 수도 없다.
		 */
		int[] nums = new int[10];
		nums[0] = 30;
//		nums[1] = "30";
...
//		nums[3] = 30f;
		...
		// 권장하는 ArrayList형 객체를 생성하는데
		// strList 객체에는 String type의 데이터만 추가할 수 있다.
		// <String>(꺽쇠) : Generic type
		// 		strList1은 ArrayList 객체이지만
		// 		여기에는 문자열만 저장하도록 하겠다.
		//		Generic type은 int, float, long, double 등은 사용 불가
		//		Generic type은 Integer, Float, Long, Double, String 등을
		//			사용해야한다.
		//		Generic type은 VO class를 사용할 수 있다.
