...
public class ScoreServiceV2 {
	 ...
	 * 그 값을 받을 변수(바구니)라고 한다.
	 * 
	 * 만약 객체.print(3,6,8) 형식으로 표출을 하면
	 * int intKor = 3, int intEng = 6, int intMath = 8 처럼 변수를 선언하는 것과 같은 코드가 된다.
	 */
	 ...
	 * 각각 intKor, intEng, intMath에 받고 세 변수의 값을 덧셈하여
	 * intSum에 저장하고 저장된 값을 Console에 출력한다.
	 */
